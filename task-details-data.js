...
window.TASK_DETAILS = {
  ...
  p0_1: {
    ...
    example: 'Email/ticket to DevOps:\n"Subject: New Azure Subscription — Rating Platform Sandbox\n\nHi Deji, we need a sandbox subscription for the Rating Platform MVP with these services:\n- Azure Container Apps (for hosting 4 microservices)\n- Azure Service Bus (for 3 message queues)\n- Azure Cosmos DB with MongoDB API (for quote storage)\n- Azure SQL Server (for ASP.NET Identity / user auth)\n- Azure Key Vault (for secrets)\n- Azure Blob Storage (for response archival)\n- Application Insights (for monitoring)\n\nResource group: rg-ratingplatform-sandbox-001"',
